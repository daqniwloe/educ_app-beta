...
import 'package:educ_app/screens/registrar_frequencia_Screen.dart';
                ...
                child: Row(
                  children: <Widget>[
                    InkWell(
                      ...
                      onTap: (){
                        Navigator.pushNamed(context, RegistrarFrequenciaScreen.routeName, arguments: ScreenArguments(index));
                      },
                    ),
                    Container(
                      padding: EdgeInsets.all(_padding),
