...
class RegistrarFrequenciaScreen extends StatefulWidget {
  static final routeName = 'registrarFrequenciaScreen';

  @override
  _RegistrarFrequenciaScreenState createState() =>
      new _RegistrarFrequenciaScreenState();
}

class _RegistrarFrequenciaScreenState extends State<RegistrarFrequenciaScreen> {
  Resp resp;
