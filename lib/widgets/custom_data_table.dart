...
class _CustomDataTableState extends State<CustomDataTable> {
  Map<String, dynamic> _listaDatas = {
    'dia1': '01/02/2020',
    'dia2': '02/02/2020',
    'dia3': '03/02/2020',
    'dia4': '04/02/2020',
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle _tituloData = TextStyle(
      color: Colors.black54,
      fontSize: 18.0,
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                Column(
                  children: _listaDatas.keys.map((key) {
                    return Container(
                      decoration: _decoration,
                      width: _anchoContainer,
                      height: _altoContainer,
                ...
                Column(
                  children: _mapaDiana.keys.map((key) {
                    return Container(
                      decoration: _decoration,
                      width: _anchoContainer,
                      height: _altoContainer,
                      child: Center(
                        child: _checkBox(key, _mapaDiana),
                      ),
                    );
                  }).toList(),
                ),
                Column(
                  children: _mapaRogerio.keys.map((key) {
                    return Container(
                      decoration: _decoration,
                      width: _anchoContainer,
                      height: _altoContainer,
                      child: Center(
                        child: _checkBox(key, _mapaRogerio),
                      ),
                    );
                  }).toList(),
                ),
